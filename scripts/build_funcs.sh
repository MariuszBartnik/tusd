...
function compile {
  ...
  GOOS=$os GOARCH=$arch CGO_ENABLED=0 go build \
    -trimpath \
    -ldflags="-X github.com/MariuszBartnik/tusd/v2/cmd/tusd/cli.VersionName=${version} -X github.com/MariuszBartnik/tusd/v2/cmd/tusd/cli.GitCommit=${commit} -X 'github.com/MariuszBartnik/tusd/v2/cmd/tusd/cli.BuildDate=$(date --utc)'" \
