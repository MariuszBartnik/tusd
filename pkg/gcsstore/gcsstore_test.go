...
import (
	...
	"github.com/MariuszBartnik/tusd/v3/pkg/gcsstore"
	"github.com/MariuszBartnik/tusd/v3/pkg/handler"
)

//go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/MariuszBartnik/tusd/v3/pkg/gcsstore GCSReader,GCSAPI
