...
import (
	...
	"github.com/MariuszBartnik/tusd/v3/pkg/azurestore"
	"github.com/MariuszBartnik/tusd/v3/pkg/handler"
	"github.com/golang/mock/gomock"
	"github.com/stretchr/testify/assert"
)

//go:generate mockgen -destination=./azurestore_mock_test.go -package=azurestore_test github.com/MariuszBartnik/tusd/v3/pkg/azurestore AzService,AzBlob
