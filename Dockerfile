...
RUN set -xe \
	&& GOOS=$TARGETOS GOARCH=$TARGETARCH go build \
        -ldflags="-X github.com/MariuszBartnik/tusd/v2/cmd/tusd/cli.VersionName=${GIT_VERSION} -X github.com/MariuszBartnik/tusd/v2/cmd/tusd/cli.GitCommit=${GIT_COMMIT} -X 'github.com/MariuszBartnik/tusd/v2/cmd/tusd/cli.BuildDate=$(date --utc)'" \
